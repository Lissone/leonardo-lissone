    ...
    jobsSection: {
      ...
      jobs: [
          ...
          experiences: [
            {
              ...
              endDate: 'Presente',
              activities: [
                'Atuação estratégica no projeto de substituição integral dos sistemas de MFO, focando em modernização tecnológica e escalabilidade.',
                'Arquitetura e migração de ecossistemas legados para um modelo Cloud Native, garantindo alta disponibilidade e resiliência.',
                'Redesenho de processos críticos de negócio, otimizando a eficiência operacional.',
              ],
            },
            {
              role: 'Engenheiro de Software',
              startDate: 'Fevereiro 2024',
              endDate: 'Janeiro 2026',
              activities: [
                'Planejamento e desenvolvimento de arquiteturas escaláveis para sistemas internos de alta complexidade.',
                'Execução de projetos de inovação com foco em performance e segurança da informação.',
                'Refatoração estratégica de sistemas legados visando escalabilidade e reuso de componentes.',
                'Desenvolvimento de ferramentas de automação que otimizaram processos operacionais críticos.',
                'Gestão do ciclo de vida de software, incluindo manutenções evolutivas e corretivas.',
              ],
            },
            {
              ...
              activities: [
                'Protagonismo na modernização de sistemas internos, elevando os níveis de manutenibilidade e performance.',
                'Desenvolvimento Full Stack de aplicações web e mobile com foco em experiência do usuário (UX).',
                'Migração bem-sucedida de sistemas legados para stacks tecnológicas modernas.',
                'Prototipagem de interfaces e fluxos de navegação utilizando Figma.',
                'Criação de automações de rotina que reduziram o esforço manual do setor operacional.',
                'Documentação técnica detalhada para planejamento de novas funcionalidades e manuais de operação.',
              ],
            },
          ],
        },
        {
          ...
          experiences: [
            {
              role: 'Estagiário de Inovação & Desenvolvimento',
              startDate: 'Setembro 2021',
              endDate: 'Março 2022',
              activities: [
                'Planejamento e prototipagem de sistemas para análise de crédito, focando em produtividade e integração de dados.',
                'Desenvolvimento de dashboards interativos aplicando princípios de UX e análise de dados para suporte à decisão.',
                'Desenvolvimento front-end de aplicações internas utilizando Angular.',
                'Processamento e geração de relatórios analíticos a partir de grandes volumes de dados (Big Data).',
              ],
            },
          ],
        },
          ...
          experiences: [
            {
              ...
              activities: [
                'Implementação de sistemas de controle para gestão pública, com impacto direto na operação de estacionamentos especiais.',
                'Desenvolvimento de novas funcionalidades para plataformas de uso público e privado.',
                'Redesign e prototipagem de softwares web internos utilizando Figma.',
                'Colaboração ativa no planejamento técnico de novos sistemas e arquiteturas.',
                'Refatoração de código para melhoria de performance em projetos existentes.',
              ],
            },
          ],
        },
